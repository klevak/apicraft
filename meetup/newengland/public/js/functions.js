...
$(function(){
	...
	var api_url = baseURL + "/meetups/newengland";
	...
	var routes = {
			...
			toggle_resource({
				...
				$.each(data.agenda, function(i, v){
					...
					var add = {
						...
						"start_minutes": (t.start.getHours() * 60) + t.start.getMinutes() - 480, 
		...
		*/
		...
		"questions": function(){
			...
			/*
			toggle_resource({ "target": $verb.self }); 
			*/
		}
	}
	...
	// click handler for resource and verb links
	$(".resource .verb").click(function(){ 
		log(".verb .resource click");
